-- ユーザーの初期データ投入
-- 注意: パスワードハッシュはダミー値です。本番環境では適切なbcryptハッシュを使用してください。
INSERT INTO users (username, email, password_hash) VALUES
    ('alice', 'alice@example.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456789'),
...
INSERT INTO todos (user_id, title, description, completed, priority, due_date) VALUES
    (1, 'Go言語の学習', 'Web APIの基礎を学ぶ', false, 1, '2025-12-31'),
    (1, 'データベース設計', 'PostgreSQLのテーブル設計を行う', true, 2, '2025-06-30'),
    ...
    (3, 'コードレビュー', 'チームメンバーのPRをレビューする', true, 1, '2025-06-15'),
